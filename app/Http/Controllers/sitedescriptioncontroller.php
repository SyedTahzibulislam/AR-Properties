...
'favicon' => 'image|mimes:jpeg,png,jpg,gif,svg|max:8048',
            
            'appletouchicon' => 'image|mimes:jpeg,png,jpg,gif,svg|max:8048',        ]);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(sitedescription $sitedescription)
    {
	
              return view('sitedescription.edit',compact('sitedescription'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, sitedescription $sitedescription)
    {
         $request->validate([
...
'favicon' => 'image|mimes:jpeg,png,jpg,gif,svg|max:8048',
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(sitedescription $sitedescription)
    {
