                ...
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="{{asset('property-single')}}\{{ $pro->id }} ">{{$pro->address_line1}}
                      <br /> {{$pro->adress_line1}}</a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">price |{{$pro->price}} TK</span>
					<span class="price-a">Area | {{$pro->area}}</span>
                  </div>
                  <a href="{{asset('property-single')}}\{{ $pro->id }}" class="link-a">Click here to view
