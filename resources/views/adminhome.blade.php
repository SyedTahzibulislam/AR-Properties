      ...
      <ul class="navbar-nav">
		...
		<li class="nav-item">
          <a class="nav-link active" aria-current="page" href= "{{url('sitedescription')}}">Site Description</a>
				...
				<li class="nav-item">
          <a class="nav-link active" aria-current="page" href= "{{url('contact')}}">Contact Details</a>
        </li>
		<li class="nav-item">
		...
		<li class="nav-item">
          <a class="nav-link active" aria-current="page" href= "{{url('property')}}">Properties</a>
				...
				<li class="nav-item">
          <a class="nav-link active" aria-current="page" href= "{{url('eventcreate')}}">Events</a>
        </li>
...
<h1 style="color:Red; text-align:center;">Welcome to Admin Panel<h1>
