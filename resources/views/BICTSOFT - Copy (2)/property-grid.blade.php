		   ...
		   <div class="img-box-a">
              ...
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  ...
                  <a href="{{asset('property-single')}}\{{ $pro->id }}'#carousel_id" class="link-a">Click here to view
		   ...
		   <div class="img-box-a">
              ...
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  ...
                  <a href="{{asset('property-single')}}\{{ $pro->id }}'#carousel_id" class="link-a">বিস্তারিত দেখতে ক্লিক করুন 
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                </div>
