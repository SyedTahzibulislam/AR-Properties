            ...
            <div class="col-md-5 section-md-t3">
              <div class="icon-box section-b2">
                ...
                <div class="icon-box-content table-cell">
                  <div >
                    <h4 style="text-align: center; background: #1abc9c; color: white; padding:20px" >আমাদের সাথে যোগাযোগ করেন </h4>
                  </div>
              ...
              <div class="icon-box section-b2">
                ...
                <div class="icon-box-content table-cell">
                  <div class="icon-box-title">
                    <h4  style="text-align: center; background: #1abc9c; color: white; padding:20px" class="icon-title">ঠিকানাঃ  </h4>
                  </div>
                  <div class="icon-box-content">
                    <p class="mb-1">
              ...
              <div class="icon-box">
                ...
                <div class="icon-box-content table-cell">
                  <div class="icon-box-title">
                    <h4 style="text-align: center; background: #1abc9c; color: white; padding:20px" class="icon-title"> সোসাল সাইটস </h4>
                  </div>
                  <div class="icon-box-content">
    ...
    @endif		   
            ...
            <div class="col-md-5 section-md-t3">
              <div class="icon-box section-b2">
                ...
                <div class="icon-box-content table-cell">
                  <div class="icon-box-title">
                    <h4 style="text-align: center; background: #1abc9c; color: white; padding:20px" class="icon-title">Contact with us</h4>
                  </div>
                  <div class="icon-box-content">
                    <p class="mb-1">Email.
                      <span class="color-a">{{ $contact->email}}</span>
              ...
              <div class="icon-box section-b2">
                ...
                <div class="icon-box-content table-cell">
                  <div class="icon-box-title">
                    <h4  style="text-align: center; background: #1abc9c; color: white; padding:20px" class="icon-title">Find us in</h4>
                  </div>
                  <div class="icon-box-content">
                    <p class="mb-1">
                    {{ $contact->address}}
              ...
              <div class="icon-box">
                ...
                <div class="icon-box-content table-cell">
                  <div class="icon-box-title">
                    <h4 style="text-align: center; background: #1abc9c; color: white; padding:20px" class="icon-title">Social networks</h4>
                  </div>
                  <div class="icon-box-content">
                    <div class="socials-footer">
                      <ul class="list-inline">
