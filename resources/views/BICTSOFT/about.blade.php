  ...
  <section class="section-about">
    <div class="container">
      <div class="row">
		...
		<div  style=" background-color:#34BF54; padding:35px;  " >
          ...
          <div class="row">
            ...
            <div    class="col-md-12">
              ...
              <p class="color-text-a">
			   ...
			   {!! nl2br(e($about->description_1st)) !!}
		
              </p>
			                <p class="color-text-a">
							  {!! nl2br(e($about->description_2nd)) !!}
	
              </p>
			  
			                <p class="color-text-a">
							  {!! nl2br(e($about->description_3rd)) !!}
		
              </p>
			  
			                <p class="color-text-a">
							  {!! nl2br(e($about->description_4th)) !!}
			
              </p>
			  
			                <p class="color-text-a">
							 {!! nl2br(e($about->description_5th)) !!}
...
<div class="col-md-4   "  >           
 <div class="col-md-12 border  border-primary"  >
  <img style="margin-top:13px; max-height:300px; "  src="/image/{{ $t->image }}"  class="card-img-top " alt="" >
  <p>
        ...
        <div class="col-md-12 section-t8">
          <div class="row">
            ...
            <div   class="col-md-12   ">
              ...
              <p class="color-text-a">
			  {!! nl2br(e($about->bndescription_1st)) !!}
		
              </p>
			                <p class="color-text-a">
							  {!! nl2br(e($about->bndescription_2nd)) !!}
		
              </p>
			  
			                <p class="color-text-a">
							 {!! nl2br(e($about->bndescription_3rd)) !!}
			
              </p>
			  
			                <p class="color-text-a">
							 {!! nl2br(e($about->bndescription_4th)) !!}
			
              </p>
			  
			                <p class="color-text-a">
							 {!! nl2br(e($about->bndescription_5th)) !!}
