      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 id="carousel_id" class="title-single">{{$pro->address_line1}}</h1>
      ...
      <div class="row">
        <div  class="col-sm-12">
			...
			<div class="carousel-item-b">
             <img  src="/image/{{ $pro->image }}" alt="A R Properties & Developers"> 
            </div>
			
			<?php } if ($pro->image1 != null ){ ?>
            <div class="carousel-item-b">
             <img  src="/image/{{ $pro->image1 }}" alt="A R Properties & Developers">
            </div>
			<?php } if ($pro->image2 != null ){ ?>
            <div class="carousel-item-b">
            <img  src="/image/{{ $pro->image2 }}" alt="A R Properties & Developers">
            </div>
			<?php } if ($pro->image3 != null ){    ?>

			  <div class="carousel-item-b">
			  
            <img  src="/image/{{ $pro->image3 }}" alt="A R Properties & Developers">
            </div>
			<?php } if ($pro->image4 != null ){ ?>
						  <div class="carousel-item-b">
            <img  src="/image/{{ $pro->image4 }}" alt="A R Properties & Developers">
            </div>
			<?php } ?>
              ...
              <div class="property-price d-flex justify-content-center foo">
                <div class="card-header-c d-flex">
                  ...
                  <div class="card-title-c align-self-center">
                    <h5 style="font-size:20px;" class="title-c">{{$pro->price}} - {{$pro->maxprice}} / Decimal</h5>
                  </div>
                </div>
              </div>
   ...
   <section class="intro-single">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 id="carousel_id" class="title-single">{{$pro->bnaddress_line1}}</h1>
            ...
            <div class="col-md-5 col-lg-4">
              ...
              <div class="property-summary">
                ...
                <div class="summary-list">
                  <ul class="list">
                    <li class="d-flex  ">
                      <strong>প্রকল্প  নং : </strong>  
                      <span style="margin-left:10px;"> 11{{$pro->id}}</span>
                    </li>
					
					                    <li class="d-flex  ">
                      <strong> মুল্য : </strong>  
                      <span style="margin-left:10px;"> {{$pro->bnprice}}- {{$pro->maxbnprice}} টাকা / শতক  </span> 
                    </li>
...
<!------------------------------------------------- Style for Youtube ---------------------------------> 
		   ...
		   <div class="tab-pane fade active " id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab">
			<?php
			$str= $pro->video;
			echo html_entity_decode($str);
