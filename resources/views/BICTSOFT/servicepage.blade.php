    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 section-t8">
					...
					<div  style=" background-color:#34BF54; padding:10px; width:30%;  " >
              ...
              <p class="color-text-a">
			    {!! nl2br(e($serv->description_1st)) !!}	
			                ...
			                <p class="color-text-a">
							  ...
							  {!! nl2br(e($serv->description_2nd)) !!}
			
              </p>
			  
			                <p class="color-text-a">
							
					 {!! nl2br(e($serv->description_3rd)) !!}		
		
              </p>
			  
			                <p class="color-text-a">
							 {!! nl2br(e($serv->description_4th)) !!}	
			
              </p>
			  
			                <p class="color-text-a">
					 {!! nl2br(e($serv->description_5th)) !!}			
          ...
          <div class="row">
            ...
            <div  class="col-md-12">
			  ...
			  {!! nl2br(e($serv->bndescription_1st)) !!}		
			                ...
			                <p class="color-text-a">
										  {!! nl2br(e($serv->bndescription_2nd)) !!}

              </p>
			  
			                <p class="color-text-a">
							 {!! nl2br(e($serv->bndescription_3rd)) !!}
	
              </p>
			  
			                <p class="color-text-a">
							 {!! nl2br(e($serv->bndescription_4th)) !!}
		
              </p>
			  
			                <p class="color-text-a">
							 {!! nl2br(e($serv->bndescription_5th)) !!}
