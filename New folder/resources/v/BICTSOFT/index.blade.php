                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <p class="intro-subtitle intro-price">
                      <span class="price-a">Price  | {{$slideshow->price}}TK/Decimal  </span>
                    </p>
                  </div>
                </div>
              </div>
		...
		<div class="col-md-4">
          <div class="card-box-c foo">
            ...
            <div class="card-footer-c">
              <a href="{{url('servicepage')}}\{{ $serv->id }}" class="link-c link-icon">Read more
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <p class="intro-subtitle intro-price">
                     <span class="price-a">মূল্য  | {{$slideshow->bnprice}} টাকা/ শতক  </span>
                    </p>
                  </div>
                </div>
              </div>
