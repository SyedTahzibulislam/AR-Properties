...
<section class="section-footer">
      ...
      <div class="row">
		...
		@foreach($about as $about )
            ...
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a"> মোবাইল নং :<a  href="tel:{{ $contact->mobile}}"> {{$contact->mobile}} </a>.</span> </li>
                <li class="color-a">
		  ...
		  <div class="widget-a">
            ...
            <div class="w-body-a">
              <ul class="list-unstyled">
                ...
                <li class="item-list-a">
                >   <a href="{{ url('aboutpage') }}">এবাউট </a>
                </li>
                <li class="item-list-a">
                 > <a href="{{ url('property-grid') }}">প্রপার্টিজ</a>
                </li>
                <li class="item-list-a">
  ...
  <footer>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
         <h3 style="color: green">আমাদের সামাজিক যোগাযোগ মাধ্যম </h3>
